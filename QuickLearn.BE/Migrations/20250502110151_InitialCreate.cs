        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    EssayText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsCorrect = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAnswerAnswers", x => new { x.SelectedAnswersId, x.UserAnswersId });
                    table.ForeignKey(
                        name: "FK_UserAnswerAnswers_Answers_SelectedAnswersId",
                        column: x => x.SelectedAnswersId,
                        principalTable: "Answers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserAnswerAnswers_UserAnswers_UserAnswersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAnswerAnswers_UserAnswersId",
                table: "UserAnswerAnswers",
